...
const TeacherProfile = () => {
    ...
    return (
        <div className="profile-page">
            <h1 className='admin-profile-heading'>Teacher Profile</h1>
            ...
            <form onSubmit={handleSaveChanges}>
                ...
                <div className="profile-info">
                    <label htmlFor="adminName">Teacher Ism</label>
                    <input type="text" id="adminName" name="adminName" value="John" readOnly />

                    <label htmlFor="adminSurname">Teacher Familiya</label>
                    <input type="text" id="adminSurname" name="adminSurname" value="Doe" readOnly />

                    <label htmlFor="adminLogin">Teacher ID</label>
