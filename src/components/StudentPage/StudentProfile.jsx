...
const StudentProfile = () => {
    ...
    return (
        <div className="profile-page">
            <h1 className='admin-profile-heading'>Student Profile</h1>
            ...
            <form onSubmit={handleSaveChanges}>
                ...
                <div className="profile-info">
                    <label htmlFor="adminName">Student Ism</label>
                    <input type="text" id="adminName" name="adminName" value="John" readOnly />

                    <label htmlFor="adminSurname">Student Familiya</label>
                    <input type="text" id="adminSurname" name="adminSurname" value="Doe" readOnly />

                    <label htmlFor="adminLogin">Student ID</label>
